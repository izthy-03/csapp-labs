...
0000000000400efc <phase_2>:
  ...
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)                  ; 6 input numbers in (%rsp) - (%rsp+20)
  400f0e:	74 20                	je     400f30 <phase_2+0x34>        ; ans[0] = 1
  400f10:	e8 25 05 00 00       	call   40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax              ; a[i]
  400f1a:	01 c0                	add    %eax,%eax                    ; a[i] * 2
  400f1c:	39 03                	cmp    %eax,(%rbx)                  ; Compare a[i] : 2 * a[i-1]
  400f1e:	74 05                	je     400f25 <phase_2+0x29>        ; ans[i] = 2 * a[i-1]
  400f20:	e8 15 05 00 00       	call   40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx                    ; (%rbx) = a[2]
  400f29:	48 39 eb             	cmp    %rbp,%rbx                    ;
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>        ; while i <= 6
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx               ; a[1]
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp              ; end of input
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                   ; a[1] in (%rsp + 0xc)
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                   ; a[0] in (%rsp + 0x8)
  ...
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)                   ; switch a[0]
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>            ; if a[0] > 7 then jump to explode_bomb
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax                   ; jump table
  400f75:	ff 24 c5 70 24 40 00 	jmp    *0x402470(,%rax,8)               ; jump to (0x402470 + 8 * a[0]) indirectly, 400f7c stored in (0x402470)
                                                                            ; .L0 case 0
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax                       ; require 207
  400f81:	eb 3b                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L2 case 2
  400f83:	b8 c3 02 00 00       	mov    $0x2c3,%eax                      ; require 707
  400f88:	eb 34                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L3 case 3  
  400f8a:	b8 00 01 00 00       	mov    $0x100,%eax                      ; require 256
  400f8f:	eb 2d                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L4 case 4
  400f91:	b8 85 01 00 00       	mov    $0x185,%eax                      ; require 389
  400f96:	eb 26                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L5 case 5
  400f98:	b8 ce 00 00 00       	mov    $0xce,%eax                       ; require 206
  400f9d:	eb 1f                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L6 case 6
  400f9f:	b8 aa 02 00 00       	mov    $0x2aa,%eax                      ; require 682
  400fa4:	eb 18                	jmp    400fbe <phase_3+0x7b>
                                                                            ; .L7 case 7
  400fa6:	b8 47 01 00 00       	mov    $0x147,%eax                      ; require 327
  ...
  400fb9:	b8 37 01 00 00       	mov    $0x137,%eax                      ; .L1 case 1    require 311
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax                   ; Compare %eax : a[1]
  400fc2:	74 05                	je     400fc9 <phase_3+0x86>            
  400fc4:	e8 71 04 00 00       	call   40143a <explode_bomb>
  400fc9:	48 83 c4 18          	add    $0x18,%rsp                       ; SOLUTION : choose one combination to defuse the bomb
  400fcd:	c3                   	ret    

0000000000400fce <func4>:                                           ; x in %rdi, y in %rsi, z in %rdx
  400fce:	48 83 ec 08          	sub    $0x8,%rsp
  400fd2:	89 d0                	mov    %edx,%eax                ; tmp = z
  400fd4:	29 f0                	sub    %esi,%eax                ; tmp -= y
  400fd6:	89 c1                	mov    %eax,%ecx                ; z - y
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx               ; (z - y) >> 31 get sign bit
  400fdb:	01 c8                	add    %ecx,%eax                ; tmp += signbit
  400fdd:	d1 f8                	sar    %eax                     ; tmp >>= 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx       ; tmp2 = tmp + y
  400fe2:	39 f9                	cmp    %edi,%ecx                ; Compare tmp2 : x
  400fe4:	7e 0c                	jle    400ff2 <func4+0x24>      ; if tmp2 > x then 
  400fe6:	8d 51 ff             	lea    -0x1(%rcx),%edx          ;   z = tmp2 - 1
  400fe9:	e8 e0 ff ff ff       	call   400fce <func4>           ;  
  400fee:	01 c0                	add    %eax,%eax                ;   
  400ff0:	eb 15                	jmp    401007 <func4+0x39>      ;   return func4(x, y, tmp2 - 1) * 2
  400ff2:	b8 00 00 00 00       	mov    $0x0,%eax                ; else
  400ff7:	39 f9                	cmp    %edi,%ecx                ;   Compare tmp2 : x
  400ff9:	7d 0c                	jge    401007 <func4+0x39>      ; 
  400ffb:	8d 71 01             	lea    0x1(%rcx),%esi           ;   if tmp2 < x
  400ffe:	e8 cb ff ff ff       	call   400fce <func4>           ;       return func4(x, tmp2 + 1, z) * 2 + 1
  401003:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax    ;       
  401007:	48 83 c4 08          	add    $0x8,%rsp                ;   else return 0
  40100b:	c3                   	ret    

000000000040100c <phase_4>:
  40100c:	48 83 ec 18          	sub    $0x18,%rsp
  401010:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx                   ; a[1]
  401015:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx                   ; a[0]
  40101a:	be cf 25 40 00       	mov    $0x4025cf,%esi
  40101f:	b8 00 00 00 00       	mov    $0x0,%eax
  401024:	e8 c7 fb ff ff       	call   400bf0 <__isoc99_sscanf@plt>
  401029:	83 f8 02             	cmp    $0x2,%eax
  40102c:	75 07                	jne    401035 <phase_4+0x29>            ; input 2 numbers, either explode_bomb
  40102e:	83 7c 24 08 0e       	cmpl   $0xe,0x8(%rsp)                   ; Compare a[0] : 14
  401033:	76 05                	jbe    40103a <phase_4+0x2e>            ; if a[0] <= 14
  401035:	e8 00 04 00 00       	call   40143a <explode_bomb>            ; if a[0] > 14 then explode_bomb
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                        ; arg_3 = 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                        ; arg_2 = 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi                   ; arg_1 = a[0]
  401048:	e8 81 ff ff ff       	call   400fce <func4>
  40104d:	85 c0                	test   %eax,%eax                        
  40104f:	75 07                	jne    401058 <phase_4+0x4c>            ; if ret_val != 0 then explode_bomb
  401051:	83 7c 24 0c 00       	cmpl   $0x0,0xc(%rsp)                   ; if a[1] !=0 then explode_bomb
...
0000000000401062 <phase_5>:
  ...
  401067:	48 89 fb             	mov    %rdi,%rbx                ; input string address in %rbx
  ...
  401092:	48 8b 14 24          	mov    (%rsp),%rdx              ; mod 16
  401096:	83 e2 0f             	and    $0xf,%edx                ;  0123456789abcdef
  ...
  4010ac:	75 dd                	jne    40108b <phase_5+0x29>    ; while i != 6
  4010ae:	c6 44 24 16 00       	movb   $0x0,0x16(%rsp)
  4010b3:	be 5e 24 40 00       	mov    $0x40245e,%esi           ; ans = "flyers"
...
00000000004010f4 <phase_6>:
  ...
  40110b:	49 89 e6             	mov    %rsp,%r14                    ; a[0] ~ a[5] stored in %rsp ~ %rsp+20

                                                                        ; Step 1 - check no repeated numbers and a[i] within 0~6
  40110e:	41 bc 00 00 00 00    	mov    $0x0,%r12d                   ; i = 0

  401114:	4c 89 ed             	mov    %r13,%rbp
  401117:	41 8b 45 00          	mov    0x0(%r13),%eax               ; a[i]
  40111b:	83 e8 01             	sub    $0x1,%eax
  40111e:	83 f8 05             	cmp    $0x5,%eax                    ; Compare a[i] : 6
  401121:	76 05                	jbe    401128 <phase_6+0x34>
  401123:	e8 12 03 00 00       	call   40143a <explode_bomb>        ; if a[i] > 6 then explode_bomb
  ...
  401138:	8b 04 84             	mov    (%rsp,%rax,4),%eax           ;     tmp1 = a[j]
  40113b:	39 45 00             	cmp    %eax,0x0(%rbp)               
  40113e:	75 05                	jne    401145 <phase_6+0x51>        ;     if a[j] == a[i] then explode_bomb
  401140:	e8 f5 02 00 00       	call   40143a <explode_bomb>
  401145:	83 c3 01             	add    $0x1,%ebx                    ;     j = j + 1
  401148:	83 fb 05             	cmp    $0x5,%ebx
  40114b:	7e e8                	jle    401135 <phase_6+0x41>        ;   while j <= 5
  40114d:	49 83 c5 04          	add    $0x4,%r13                    ; i = i + 1
  401151:	eb c1                	jmp    401114 <phase_6+0x20>
                                                                        ; else
                                                                        ; Step 2 - Let a[i] = 7 - a[i]
  401153:	48 8d 74 24 18       	lea    0x18(%rsp),%rsi              ; end of a[]
  401158:	4c 89 f0             	mov    %r14,%rax                    ; *p = a
  40115b:	b9 07 00 00 00       	mov    $0x7,%ecx                    ; for(i = 0; i < 6; i++)
  401160:	89 ca                	mov    %ecx,%edx                    ;   a[i] = 7 - a[i]
  ...
  40116d:	75 f1                	jne    401160 <phase_6+0x6c>
                                                                        ...
                                                                        ; Step 3 - nextlist[i] = node_p[a[i] - 1] , a[i] > 1 ; nextlist[k] = &Node[0] 
  40116f:	be 00 00 00 00       	mov    $0x0,%esi                    ; i = 0
  401174:	eb 21                	jmp    401197 <phase_6+0xa3>        ; jump-to-middle
                                                                        ; while(1)
                                                                        ; {
  401176:	48 8b 52 08          	mov    0x8(%rdx),%rdx               ;   node_p = node_p->next
  40117a:	83 c0 01             	add    $0x1,%eax                        
  40117d:	39 c8                	cmp    %ecx,%eax
  40117f:	75 f5                	jne    401176 <phase_6+0x82>        ;   %eax = a[i]    
  401181:	eb 05                	jmp    401188 <phase_6+0x94>        ;   goto .L2                                                                         
                                                                        ; .L1
                                                                        ;   // it's a linklist!!!   (gdb) x/12gx 0x6032d0
                                                                                                    0x6032d0 <node1>:       0x10000014c      0x6032e0
                                                                                                    0x6032e0 <node2>:       0x2000000a8      0x6032f0
                                                                                                    0x6032f0 <node3>:       0x30000039c      0x603300
                                                                                                    0x603300 <node4>:       0x4000002b3      0x603310
                                                                                                    0x603310 <node5>:       0x5000001dd      0x603320
                                                                                                    0x603320 <node6>:       0x6000001bb      0x000000               
                                                                        ; node_p[5] = {0x6032d0, 0x6032e0, 0x6032f0, 
                                                                                       0x603300, 0x603310, 0x603320}
                                                                        ;   struct node(16B) Node[5] start at 0x6032d0
  401183:	ba d0 32 60 00       	mov    $0x6032d0,%edx                   *node_p = Node
                                                                        ; .L2
  401188:	48 89 54 74 20       	mov    %rdx,0x20(%rsp,%rsi,2)       ;   nextlist[i] = node_p[a[i] - 1]
  40118d:	48 83 c6 04          	add    $0x4,%rsi                    ;   i++
  401191:	48 83 fe 18          	cmp    $0x18,%rsi                   ; 
  401195:	74 14                	je     4011ab <phase_6+0xb7>        ;   if i == 6 then break
  401197:	8b 0c 34             	mov    (%rsp,%rsi,1),%ecx           ;   %ecx = a[i]
  40119a:	83 f9 01             	cmp    $0x1,%ecx                    ;   
  40119d:	7e e4                	jle    401183 <phase_6+0x8f>        ;   if a[i] <= 1 then nextlist[i] = node_p[0]
                                                                        ;   
  40119f:	b8 01 00 00 00       	mov    $0x1,%eax                        
  4011a4:	ba d0 32 60 00       	mov    $0x6032d0,%edx
  4011a9:	eb cb                	jmp    401176 <phase_6+0x82>        ; }

  4011ab:	48 8b 5c 24 20       	mov    0x20(%rsp),%rbx              ; %rbx = nextlist[0],  j = 0
  4011b0:	48 8d 44 24 28       	lea    0x28(%rsp),%rax              ; %rax = &nextlist[1], i = 1
  4011b5:	48 8d 74 24 50       	lea    0x50(%rsp),%rsi              ; %rsi = &nextlist[6] (end)
  4011ba:	48 89 d9             	mov    %rbx,%rcx                    ; %rcx = nextlist[0]
                                                                        ; 
  4011bd:	48 8b 10             	mov    (%rax),%rdx                  ; %rdx = nextlist[i]
  4011c0:	48 89 51 08          	mov    %rdx,0x8(%rcx)               ; nextlist[i - 1]->next = nextlist[i]
  4011c4:	48 83 c0 08          	add    $0x8,%rax                    ; i++
  4011c8:	48 39 f0             	cmp    %rsi,%rax                        
  4011cb:	74 05                	je     4011d2 <phase_6+0xde>        ; if i == 6 then break
  4011cd:	48 89 d1             	mov    %rdx,%rcx                    ; iterate
...
0000000000401204 <fun7>:
  ...
  401208:	48 85 ff             	test   %rdi,%rdi              ; if !ptr then return -1
  40120b:	74 2b                	je     401238 <fun7+0x34>     
  40120d:	8b 17                	mov    (%rdi),%edx
  40120f:	39 f2                	cmp    %esi,%edx              ; Compare ptr->data : x
  401211:	7e 0d                	jle    401220 <fun7+0x1c>     ; 
                                                              ; if ptr->data > x
  401213:	48 8b 7f 08          	mov    0x8(%rdi),%rdi         ;   
  401217:	e8 e8 ff ff ff       	call   401204 <fun7>          ;   ret = fun7(ptr->lson, x)
  40121c:	01 c0                	add    %eax,%eax              ;   return ret <<= 1
  40121e:	eb 1d                	jmp    40123d <fun7+0x39>     ;  
                                                              ; else
  401220:	b8 00 00 00 00       	mov    $0x0,%eax              ;   
  401225:	39 f2                	cmp    %esi,%edx              ;   if ptr->data == x
  401227:	74 14                	je     40123d <fun7+0x39>     ;     return 0
  401229:	48 8b 7f 10          	mov    0x10(%rdi),%rdi        ;   
  40122d:	e8 d2 ff ff ff       	call   401204 <fun7>          ; ret = fun7(ptr->rson, x)
  401232:	8d 44 00 01          	lea    0x1(%rax,%rax,1),%eax  ; return ret << 1 | 1
...
0000000000401242 <secret_phase>:
  ...
  401260:	3d e8 03 00 00       	cmp    $0x3e8,%eax                    ; input <= 0x3e9
...
000000000040131b <string_length>:
  ...
  40131e:	74 12                	je     401332 <string_length+0x17>          ; if (%rdi) == 0 then return 0
  401320:	48 89 fa             	mov    %rdi,%rdx                             
  401323:	48 83 c2 01          	add    $0x1,%rdx                             
  401327:	89 d0                	mov    %edx,%eax
  401329:	29 f8                	sub    %edi,%eax                            ; length = length + 1
  40132b:	80 3a 00             	cmpb   $0x0,(%rdx)
  40132e:	75 f3                	jne    401323 <string_length+0x8>           ; while (%rdx) != '\0'
  401330:	f3 c3                	repz ret                                    ; return length
...
0000000000401338 <strings_not_equal>:
  ...
  40133a:	55                   	push   %rbp
  40133b:	53                   	push   %rbx
  40133c:	48 89 fb             	mov    %rdi,%rbx                            ; input_string in %rdi -> %rbx
  40133f:	48 89 f5             	mov    %rsi,%rbp                            ; answer_string in $rsi -> %rbp
  401342:	e8 d4 ff ff ff       	call   40131b <string_length>               ; return input_string length
  401347:	41 89 c4             	mov    %eax,%r12d                           ; input_string length in %r12d
  40134a:	48 89 ef             	mov    %rbp,%rdi
  40134d:	e8 c9 ff ff ff       	call   40131b <string_length>               ; return answer_string length in %rax
  401352:	ba 01 00 00 00       	mov    $0x1,%edx                            ; %rdx = 1
  401357:	41 39 c4             	cmp    %eax,%r12d                           ; Compare length
  40135a:	75 3f                	jne    40139b <strings_not_equal+0x63>      ; if length not equal
  40135c:	0f b6 03             	movzbl (%rbx),%eax                          ; get next char of input_string in $eax
  40135f:	84 c0                	test   %al,%al                              ; '\0' (1Byte)
  401361:	74 25                	je     401388 <strings_not_equal+0x50>      ; if passed all cmp and reaches '\0'
  401363:	3a 45 00             	cmp    0x0(%rbp),%al                        ; Compare one char
  401366:	74 0a                	je     401372 <strings_not_equal+0x3a>      ; if equal then jump
  401368:	eb 25                	jmp    40138f <strings_not_equal+0x57>      ; else return 1
  ...
  40139b:	89 d0                	mov    %edx,%eax                            ; if not equal then return 1
  40139d:	5b                   	pop    %rbx
  40139e:	5d                   	pop    %rbp
...
000000000040145c <read_six_numbers>:
  ...
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx                   ; %rsi + 4
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax                  ; %rsi + 20
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)                   ; %rsi + 20 in (%rsp + 8)
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax                  ; %rsi + 16
  401474:	48 89 04 24          	mov    %rax,(%rsp)                      ; %rsi + 16 in (%rsp)
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9                    ; %rsi + 12
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8                    ; %rsi + 8
  401480:	be c3 25 40 00       	mov    $0x4025c3,%esi
  401485:	b8 00 00 00 00       	mov    $0x0,%eax
  40148a:	e8 61 f7 ff ff       	call   400bf0 <__isoc99_sscanf@plt>     ; pass 8 args to sscanf
  40148f:	83 f8 05             	cmp    $0x5,%eax
  401492:	7f 05                	jg     401499 <read_six_numbers+0x3d>           ; if %eax > 5
